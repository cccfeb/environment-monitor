...
export const CONST = {
  ...
  sensorTopic:        '', //the mqtt topic string for sensor readings

  //aws
  awsHost:            '', //the aws instance url, 'wss://' will be prepended to this
  awsRegion:          '', //
  awsSecretKey:       '', //
  awsAccessKey:       '', //
